...
#define MOTOR_B_DIRECTION_FORWARD	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_10, GPIO_PIN_RESET)
#define MOTOR_B_DIRECTION_BACKWARD	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_10, GPIO_PIN_SET)

#define MOTOR_A_STEP_PIN_PORT GPIOA
#define MOTOR_A_STEP_PIN_PIN  GPIO_PIN_9

#define MOTOR_B_STEP_PIN_PORT GPIOC
#define MOTOR_B_STEP_PIN_PIN  GPIO_PIN_7
